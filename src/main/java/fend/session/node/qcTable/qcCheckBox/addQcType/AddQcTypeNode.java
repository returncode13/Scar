 ...
 */
package fend.session.node.qcTable.qcCheckBox.addQcType;
...
public class AddQcTypeNode extends AnchorPane{
    ...
    public AddQcTypeNode(AddQcTypeModel ism){
         this.location=getClass().getClassLoader().getResource("nodeResources/qctable/qcCheckBox/addQcType/addQcType.fxml"); 
