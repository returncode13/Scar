...
import fend.session.node.jobs.types.type2.JobStepType2NodeController;*/
...
public class JobStepType4Node extends AnchorPane implements JobStepType0Node{
   ...
   private JobStepType4Model jmodel;
    
    
    
    static int i=0;
    public JobStepType4Node(JobStepType4Model item) {
      
        this.jmodel=item;
        this.location=getClass().getClassLoader().getResource("nodeResources/jobs/types/type4/JobStepType4NodeView_1.fxml"); 
        //URL location = JobStepNodeController.class.getResource("JobStepNodeView.fxml");
           ...
           fXMLLoader=new FXMLLoader();
            ...
            try{
                ...
                jsnc=(JobStepType4NodeController)fXMLLoader.getController();
             //i++;
        ...
        mOnDragOver=new EventHandler<DragEvent>() {
          ...
          //      throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
              ...
              // System.out.println("JobStepNode :mOnDragOver: ");
                JobStepType4Node.this.relocateToPoint(new Point2D(event.getSceneX(), event.getSceneY()));
        ...
        setOnMouseDragReleased(new EventHandler<MouseDragEvent>(){
            ...
            public void handle(MouseDragEvent event) {
              ...
              //  System.out.println("JobStepNode :setOnMouseDragReleased: ");
               List<LinksModel> llm=JobStepType4Node.this.jmodel.getListOfLinkModels(); 
               ...
               lm.setChild(JobStepType4Node.this.jmodel);                        //the node the anchor is dropped on
             ...
             //  System.out.println("JSN: Mouse Drag Released on "+getId()+ " source "+event.getSource().getClass().getSimpleName()+ " SourceID: "+ jsource.getId()+" GSource: "+event.getGestureSource().getClass().getSimpleName()+ " Target: "+event.getTarget().getClass().getSimpleName());
               ...
               curve.endXProperty().bind(Bindings.add(JobStepType4Node.this.layoutXProperty(),JobStepType4Node.this.boundsInLocalProperty().get().getMinX()));// JobStepNode.this.getWidth()/2.0));
               curve.endYProperty().bind(Bindings.add(JobStepType4Node.this.layoutYProperty(),JobStepType4Node.this.boundsInLocalProperty().get().getMaxY()/2));//JobStepNode.this.getWidth()/2.0));
...
//                System.out.println("Link # "+link.getId()+ "now connects Parent : "+link.getStart().getModel().getJob().getJsId() +" to Child :"+link.getEnd().getModel().getJob().getJsId());
    ...
    private void buildMenuHandlers(){
        ...
        setOnContextMenuRequested(new EventHandler<ContextMenuEvent>() {
            ...
            menu.show(JobStepType4Node.this, event.getScreenX(), event.getScreenY());
        ...
        */
             ...
             public void handle(ActionEvent event) {
                // throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
                 double startX=getScene().getX();
                   ...
                   System.out.println("fend.session.node.jobs.JobStepNode.   MAXY: "+JobStepType4Node.this.boundsInLocalProperty().get().getMaxY());
                   System.out.println("Curve will start @(x,y) = ("+startX+","+startY+")");
                    ...
                    mStart.setJob(JobStepType4Node.this.jmodel);
                   ...
                   JobStepType4Model jmod=JobStepType4Node.this.jmodel;
        ...
        deleteThisJob.setOnAction(new EventHandler<ActionEvent>() {
             ...
             @Override
             public void handle(ActionEvent event) {
                 System.out.println("fend.session.node.jobs.JobStepNode. This will delete this node with id: "+JobStepType4Node.this.getId()+" session: "+JobStepType4Node.this.jmodel.getSessionModel().getName()+" : with sessionID: "+JobStepType4Node.this.jmodel.getSessionModel().getId());
                 JobStepType4Node.this.jmodel.getSessionModel().removeJobfromSession(jmodel);
                 JobStepType4Node.this.jmodel.getSessionModel().addToDeleteList(jmodel);
                 List<LinksModel> lmlist=JobStepType4Node.this.jmodel.getListOfLinkModels();
                 
                 List<JobStepType0Model> parents=JobStepType4Node.this.jmodel.getJsParents();
                 for (Iterator<JobStepType0Model> iterator = parents.iterator(); iterator.hasNext();) {
                     ...
                     for (Iterator<LinksModel> iterator1 = lmodp.iterator(); iterator1.hasNext();) {
                         ...
                         if(lmp.getChild().getId().equals(JobStepType4Node.this.jmodel.getId()))
                         {
                 ...
                 List<JobStepType0Model> children=JobStepType4Node.this.jmodel.getJsChildren();
                 for (Iterator<JobStepType0Model> iterator = children.iterator(); iterator.hasNext();) {
                     ...
                     for (Iterator<LinksModel> iterator1 = lmodc.iterator(); iterator1.hasNext();) {
                         ...
                         if(lmc.getChild().getId().equals(JobStepType4Node.this.jmodel.getId()))
                         {
                 ...
                 JobStepType4Node.this.setVisible(false);
             }
         });
        /*
    ...
    public JobStepType4NodeController getJsnc() {                                                            //for debug only ..remove 
        return jsnc;
    }
