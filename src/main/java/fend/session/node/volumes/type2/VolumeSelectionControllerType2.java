 ...
 */
public class VolumeSelectionControllerType2 implements VolumeSelectionControllerType0  {
    ...
    private VolumeSelectionModelType2 model;
    ...
    public VolumeSelectionModelType2 getModel() {
        return model;
    }

    public void setModel(VolumeSelectionModelType2 model) {
