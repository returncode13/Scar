...
public class VolumeSelectionModelType4 implements VolumeSelectionModelType0{
  ...
  //  private Set<Long> wfVersionsUsedinVolume=new HashSet<>();
    ...
    */
    ...
    public VolumeSelectionModelType4(String volumeSelectionLabel,Boolean toBeInflated,Long volumeType,JobStepType0Model pjob) {
        ++i;
     ...
     public VolumeSelectionModelType4(Boolean toBeinflated,long volumeType,JobStepType0Model pjob) {
        
        this(new String ("choose Text Folder: "),toBeinflated,volumeType,pjob);
       //  this.headersModel.setVolmodel(this);
    }
    
    public VolumeSelectionModelType4(Long volumeType,JobStepType0Model pjob){
        this(new String ("choose Text Folder: "),false,volumeType, pjob);
         //this.headersModel.setVolmodel(this);
